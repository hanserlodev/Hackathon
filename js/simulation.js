...
class MeteorSimulation {
    constructor() {
        ...
        this.referenceLocations = [
            { query: 'ciudad de méxico', lat: 19.4326, lon: -99.1332, label: 'Ciudad de México, México' },
            { query: 'madrid', lat: 40.4168, lon: -3.7038, label: 'Madrid, España' },
            { query: 'tokio', lat: 35.6764, lon: 139.6500, label: 'Tokio, Japón' },
            { query: 'buenos aires', lat: -34.6037, lon: -58.3816, label: 'Buenos Aires, Argentina' },
            { query: 'nairobi', lat: -1.2864, lon: 36.8172, label: 'Nairobi, Kenia' }
        ];
