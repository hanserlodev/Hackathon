...
export const NEO_DATABASE = [
    ...
    { name: "2019 GJ4", diameter: 26.90, velocity: 39845.71, category: "20-40m" },
    ...
    { name: "2013 XY20", diameter: 32.03, velocity: 10548.44, category: "20-40m" },
    ...
    { name: "2025 PJ3", diameter: 39.40, velocity: 42073.32, category: "40-60m" },
    ...
    { name: "2025 RC3", diameter: 47.00, velocity: 43412.33, category: "40-60m" },
    { name: "2021 AN", diameter: 51.94, velocity: 66859.67, category: "40-60m" },
    { name: "2023 RG13", diameter: 55.15, velocity: 68028.86, category: "40-60m" },
    
    // 60-80m range (5 objects)
    { name: "2021 CD1", diameter: 64.20, velocity: 69564.57, category: "60-80m" },
    { name: "2022 KF", diameter: 52.18, velocity: 104674.68, category: "60-80m" },
    { name: "2025 SQ2", diameter: 66.89, velocity: 35920.20, category: "60-80m" },
    { name: "2025 QU11", diameter: 70.72, velocity: 33163.25, category: "60-80m" },
    { name: "2018 RZ7", diameter: 74.74, velocity: 37651.79, category: "60-80m" },
    
    // 80-100m range (4 objects)
    { name: "2025 RT1", diameter: 76.83, velocity: 53828.80, category: "80-100m" },
    { name: "2010 RJ43", diameter: 78.26, velocity: 38591.53, category: "80-100m" },
    { name: "2025 QA18", diameter: 85.02, velocity: 24385.80, category: "80-100m" },
    { name: "2025 QS5", diameter: 86.21, velocity: 47597.51, category: "80-100m" },
    
    // 100-120m range (3 objects)
    { name: "2018 RW1", diameter: 89.86, velocity: 25778.68, category: "100-120m" },
    { name: "2023 HO4", diameter: 98.98, velocity: 24580.15, category: "100-120m" },
    { name: "2002 RS129", diameter: 112.60, velocity: 56380.88, category: "100-120m" },
    
    // 120-140m range (2 objects)
    { name: "2025 OG24", diameter: 119.55, velocity: 65374.46, category: "120-140m" },
    { name: "2023 AA1", diameter: 129.28, velocity: 25349.91, category: "120-140m" },
    
    // 140-160m range (1 object)
    { name: "2025 QX3", diameter: 147.76, velocity: 40574.25, category: "140-160m" },
    
    // 160-180m range (2 objects)
    { name: "2003 SU84", diameter: 157.60, velocity: 52053.77, category: "160-180m" },
    { name: "2022 AL3", diameter: 174.40, velocity: 56282.73, category: "160-180m" },
    
    // 180-200m range (2 objects)
    { name: "2025 OE13", diameter: 184.31, velocity: 59687.33, category: "180-200m" },
    { name: "2025 SC42", diameter: 185.76, velocity: 42333.27, category: "180-200m" },
    
    // 220-240m range (1 object)
    { name: "2025 GQ", diameter: 229.90, velocity: 54241.93, category: "220-240m" },
    
    // 260-280m range (1 object)
    { name: "2017 QY34", diameter: 280.25, velocity: 99164.56, category: "260-280m" },
    
    // 280-300m range (1 object)
    { name: "2012 LF11", diameter: 298.91, velocity: 93479.54, category: "280-300m" },
    
    // 300-320m range (1 object)
    { name: "2024 NO5", diameter: 311.56, velocity: 36524.75, category: "300-320m" },
    
    // 380-400m+ range (1 object)
    { name: "2009 CA3", diameter: 401.37, velocity: 41673.71, category: "400m+" },
    
    // Additional objects
    { name: "1998 SD9", diameter: 65.39, velocity: 82121.80, category: "60-80m" },
