...
export const KNOWN_ASTEROIDS = {
  ...
  1862: {
    // Apollo - Namesake of Apollo group
    name: "1862 Apollo",
    spkId: "2001862",
    type: "asteroid",
    neo: true,
  ...
  4769: {
    // Castalia - First radar-imaged asteroid
    name: "4769 Castalia",
    spkId: "2004769",
    type: "asteroid",
    neo: true,
  ...
  29075: {
    // 1950 DA - High impact probability in 2880
    name: "29075 (1950 DA)",
    spkId: "2029075",
    type: "asteroid",
    neo: true,
  ...
  433: {
    // Eros - Largest NEO, NEAR Shoemaker target
    name: "433 Eros",
    spkId: "2000433",
    type: "asteroid",
    neo: true,
  ...
  3200: {
    // Phaethon - Geminid meteor shower parent
    name: "3200 Phaethon",
    spkId: "2003200",
    type: "asteroid",
    neo: true,
  ...
  6489: {
    // Golevka - Yarkovsky effect detection
    name: "6489 Golevka",
    spkId: "2006489",
    type: "asteroid",
    neo: true,
  ...
  3753: {
    // Cruithne - Earth quasi-satellite
    name: "3753 Cruithne",
    spkId: "2003753",
    type: "asteroid",
    neo: true,
  ...
  1580: {
    // Betulia - Mars-crossing asteroid
    name: "1580 Betulia",
    spkId: "2001580",
    type: "asteroid",
    neo: true,
  ...
  1866: {
    // Sisyphus - Large Apollo asteroid
    name: "1866 Sisyphus",
    spkId: "2001866",
    type: "asteroid",
    neo: true,
...
export function enhanceAsteroidData(apiData, designation) {
  const knownData =
    KNOWN_ASTEROIDS[designation] ||
    KNOWN_ASTEROIDS[designation.replace(/\s+/g, "")];
  ...
  return {
    ...
    orbit: {
      ...
      semiMajorAxis:
        apiData.orbit?.semiMajorAxis || knownData.orbit.semiMajorAxis,
      inclination: apiData.orbit?.inclination || knownData.orbit.inclination,
      ascendingNode:
        apiData.orbit?.ascendingNode || knownData.orbit.ascendingNode,
      argPerihelion:
        apiData.orbit?.argPerihelion || knownData.orbit.argPerihelion,
      meanAnomaly: apiData.orbit?.meanAnomaly || knownData.orbit.meanAnomaly,
      period: apiData.orbit?.period || knownData.orbit.period,
    },
    physical: {
      diameter:
        apiData.physical?.diameter && apiData.physical.diameter > 0
          ? apiData.physical.diameter
          : knownData.physical.diameter,
      albedo:
        apiData.physical?.albedo && apiData.physical.albedo > 0
          ? apiData.physical.albedo
          : knownData.physical.albedo,
      magnitude:
        apiData.physical?.magnitude && apiData.physical.magnitude > 0
